...
foreach($sniffed as $grpaddr => $value){
    ...
    if ( $sniffed[$grpaddr]['is_track'] == 1){
	        	//Inseetion en base de donnÃƒÂ©es car l'eqt is_track=true
...
//on ecrit les donnÃ©es dans le fichier json trace
...
*/ 
System_Daemon::info("Mise a jour du fichier knxtrace.json a chaque modification d'un equipement suivi et sauvegarde en base s'il doit etre historisÃ©");
//$lastpos = 0;
while (true) {
